package com.LearningProject.JavaAdvanced.Exceptions.ThorwingExceptions;
...
public class AccountException extends Exception{
    public AccountException(Exception cause) { // Here we are taking the cause of this more general purpose exception
        ...
        // So on initialization of this exception, the cause of this exception is being passed to the Exception class, which
