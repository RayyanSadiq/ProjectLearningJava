package com.LearningProject.JavaBasics.DataTypes.Strings;
...
public class Strings {
    public static  void main(String[] args) {
        ...
        /*
        Here's what the trim() method does:

         Leading Whitespace: It removes any whitespace characters at the beginning (start) of the string.
         Trailing Whitespace: It removes any whitespace characters at the end (tail) of the string.

         It returns a new string with leading and trailing whitespace removed, leaving the original string unchanged.
         */

        String wordThatNeedsToBeTrimmed = "    I need to be trimmed                ";
        System.out.println(wordThatNeedsToBeTrimmed.trim()); // prints "I need to be trimmed"
        ...
        // We have two variables with a name of "jake". In the memory we have a space called heap, remember that?
        // Well in it comes to strings they are stored in the heap because they are a reference type, however they have
        // a special place in the heap called a String Pool, this is a place where all strings go in memory.

        // Now in the String Pool, if there is already a string value stored in there, and then you make another
        // variable with the exact same name, the variable will point to the same object in memory, and basically
        // reuse it. I can still use name1 independently of name2, this is a feature to save space and be more efficient.
