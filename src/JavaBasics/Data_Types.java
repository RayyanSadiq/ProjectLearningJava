...
public class Data_Types {
    public static void main(String[] args) {
        ...
        int Primitive_type3 = 21000000; // shorts take up a space of 4 bytes and the range is -2b to 2b
        ...
        // an important rule of Reference data types is that they need to be capitalized when using them.
