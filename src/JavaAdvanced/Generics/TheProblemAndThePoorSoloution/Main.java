...
public class Main {
    public static void main(String[] args) {
        ...
        // valueOf() which returns a new instance eof the new integer class. So what java does in the background is
        ...
        // (int). Then there is chance the value at the index we are trying to assign to a int variable might not be
        // an integer data type, so then that would cause a casting error, and we would not know about it till runtime
